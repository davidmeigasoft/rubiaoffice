...
<div class="innerLR">
	<form name="form" method="post" class="form-horizontal" action="<?php echo base_url().'admin_blog/alta_blog'; ?>">
				...
				<div class="widget-body" style="padding-bottom: 0;">
                   ...
                   <!--Fila de mensaje de error-->
                    ...
                    <div class="control-group row-fluid">
						...
						<div class="controls">
							<input name="tag" type="hidden" id="select2_5" style="width: 100%;" value="<?php echo set_value('tag'); ?>" />
						</div>
					</div>
